...
int main(int argc, char* argv[])
{
    ...
    if ( pSpriteTourSol )  //si le permier sprite a bien �t� charg�, on suppose que les autres aussi
    {
        ...
        while ( cont != 0 ){   //VOUS DEVEZ GERER (DETECTER) LA FIN DU JEU -> tourRoiDetruite
                ...
                //a supprimer, c'est juste pour attirer votre attention sur comment est g�rer le chemin (un tableau 2D de coordonn�es)(regarder le corps de afficheCoordonneesParcours)
